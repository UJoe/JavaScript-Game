...
function initGame() {
  ...
  function newRoom() {
    step++;
    let curRoom = room;
    room = parseInt(Math.random() * 10); // rooms.length);
    if (room === curRoom) {
      room += 1;
    ...
    if (rooms[room].type === "attack") {
      ...
      <img id='roomImg' src='${rooms[room].roomPic}' alt='Attack Room'><br>
        ...
        <div id="fightersPic">
          <div id="fightButtons">
            <button id='attackBtn'>Támadás</button> <br>
            <button id='mAttackBtn'>Hackelés</button> <br>
            <button id='fleeBtn'>Menekülés</button> <br>
            <div id='other'></div>
          </div>
        ...
        <div id="panel">
          ...
          <div id='values'>
            <div id='charValues'>JELLEMZŐID
              <br>Erő: <span class="spanValue" id='val_0_1' style='width: ${15 + char[0].hp * 1.5}px;'>${char[0].hp}</span>
              <br>Támadás: <span class="spanValue" id='val_0_2' style='width: ${15 + char[0].att * 1.5}px;'>${char[0].att}</span>
              <br>Védekezés: <span class="spanValue" id='val_0_3' style='width: ${15 + char[0].def * 1.5}px;'>${char[0].def}</span>
              <br>Hackelés: <span class="spanValue" id='val_0_4' style='width: ${15 + char[0].mAtt * 1.5}px;'>${char[0].mAtt}</span>
              <br>Tűzfal: <span class="spanValue" id='val_0_5' style='width: ${15 + char[0].mDef * 1.5}px;'>${char[0].mDef}</span>
            </div>
            <div id='objectsInAtk'>
            ...
            <div id='nmeValues'>ELLENFÉL
              <br>Erő: <span class="spanValue" id='val_1_1' style='width: ${15 + char[1].hp * 1.5}px;'>${char[1].hp}</span>
              <br>Támadás: <span class="spanValue" id='val_1_2' style='width: ${15 + char[1].att * 1.5}px;'>${char[1].att}</span>
              <br>Védekezés: <span class="spanValue" id='val_1_3' style='width: ${15 + char[1].def * 1.5}px;'>${char[1].def}</span>
              <br>Hackelés: <span class="spanValue" id='val_1_4' style='width: ${15 + char[1].mAtt * 1.5}px;'>${char[1].mAtt}</span>
              <br>Tűzfal: <span class="spanValue" id='val_1_5' style='width: ${15 + char[1].mDef * 1.5}px;'>${char[1].mDef}</span>
            </div>
          </div>
        </div>
      `;
      //ellenfél értékei
      char[1].hp = parseInt(step / 2 + rooms[room].values[0] * 20 + Math.random() * 40);
      changeVal(1, 1, char[1].hp);
      char[1].att = parseInt(step / 2 + rooms[room].values[1] * 20 + Math.random() * 40);
      changeVal(1, 2, char[1].att);
      char[1].def = parseInt(step / 2 + rooms[room].values[2] * 20 + Math.random() * 40);
      changeVal(1, 3, char[1].def);
      char[1].mAtt = parseInt(step / 2 + rooms[room].values[3] * 20 + Math.random() * 40);
      changeVal(1, 4, char[1].mAtt);
      char[1].mDef = parseInt(step / 2 + rooms[room].values[4] * 20 + Math.random() * 40);
      changeVal(1, 5, char[1].mDef);
      document.getElementById("other").innerHTML = "";
      let attBtn = document.getElementById("attackBtn");
      let mAttBtn = document.getElementById("mAttackBtn");
      ...
      document.getElementById("attackBtn").addEventListener("click", function () {
        ...
        if (x < 1) {
          ...
          char[1].hp -= Math.floor(x/2);
          changeVal(1, 1, char[1].hp);
          char[0].att ++;
          changeVal(0, 2, char[0].att);
          message("Vad támadásoddal " + x + " Erőt sebeztél ellenfeleden!")
          checkDeath();
        };
        clearTimeout(timo);
